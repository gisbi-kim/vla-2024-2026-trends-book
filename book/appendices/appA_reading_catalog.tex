...
\begin{table}[h]
  ...
  \begin{tabularx}{\textwidth}{>{\bfseries}p{30mm}p{24mm}p{28mm}X}
    ...
    World Pilot/LaWAM/AHA-WAM \citep{worldpilot2026,lawam2026,ahawam2026} & arXiv & WAM policy utility & World-action model을 future video quality가 아니라 steering, latency, real-robot utility로 읽는다. \\
    ROAD-VLA/FORCE \citep{roadvla2026,forcevla2026} & arXiv & Online adaptation/RL & Sparse reward를 action-level supervision으로 바꾸는 방식과 exploration cost를 확인한다. \\
    LIBERO-Safety/ForesightSafety \citep{liberosafety2026,foresightsafety2026} & arXiv & Safety benchmark & Success rate와 unsafe success, process risk, failure source diagnosis를 분리한다. \\
    LabVLA/MuseVLA/ACE-Ego-0 \citep{labvla2026,musevla2026,aceego2026} & arXiv & Cross-domain data & Domain protocol, sensor modality, human-video supervision을 VLA data contract로 읽는다. \\
    \bottomrule
  \end{tabularx}
\end{table}
